export function ProgramSection() {
  const modules = [
    {
      ...
      description:
        "Погружение в iGaming-вертикаль, настройка среды, анатомия креативов",
      lessons: [
    ...
    },
    {
      ...
      description:
        "Новейшие AI-технологии для создания и автоматизации креативов",
      lessons: [
        "4.1 Midjourney/SD",
    ...
    },
    {
      ...
      description:
        "JavaScript в AE, 3D-пространство, автоматизация — уровень профессионала",
      lessons: [
    ...
    },
    {
      ...
      description:
        "Метрики, аналитика, психология конверсий — маркетинговая сторона креативов",
      lessons: [
  ...
  return (
    <section id="program" className="py-10 md:py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-10 md:mb-16 space-y-3 md:space-y-4">
          ...
          <p className="text-sm md:text-lg text-[#9D95B0] max-w-2xl mx-auto px-2 leading-relaxed">
            Пошаговая программа: от основ After Effects до создания полноценных
            рекламных креативов для iGaming вертикали.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-5 mb-6 md:mb-8">
          ...
          <div className="lg:col-span-2 bg-[#16112A] border border-purple-500/15 rounded-2xl md:rounded-3xl p-5 md:p-8 space-y-3 md:space-y-4 hover:border-purple-500/30 transition-all">
            ...
            <p className="text-sm md:text-base text-[#9D95B0]">
              Реальный бриф, производство, оценка готовности, процесс найма в
              компаниях
            </p>
            <ul className="space-y-2 md:space-y-3 pt-1 md:pt-2">
              <li className="flex items-start gap-2 md:gap-3">
                <div className="w-1.5 h-1.5 rounded-sm bg-purple-500 mt-1.5 md:mt-2 flex-shrink-0" />
                <span className="text-xs md:text-sm text-[#D1D0D8]">
                  7.1 Реальный бриф + производство
                </span>
              </li>
              <li className="flex items-start gap-2 md:gap-3">
                <div className="w-1.5 h-1.5 rounded-sm bg-purple-500 mt-1.5 md:mt-2 flex-shrink-0" />
                <span className="text-xs md:text-sm text-[#D1D0D8]">
                  7.2 Защита проекта и фидбек
                </span>
              </li>
              <li className="flex items-start gap-2 md:gap-3">
                <div className="w-1.5 h-1.5 rounded-sm bg-purple-500 mt-1.5 md:mt-2 flex-shrink-0" />
                <span className="text-xs md:text-sm text-[#D1D0D8]">
                  7.3 Процесс найма в iGaming
                </span>
              </li>
              <li className="flex items-start gap-2 md:gap-3">
                <div className="w-1.5 h-1.5 rounded-sm bg-purple-500 mt-1.5 md:mt-2 flex-shrink-0" />
                <span className="text-xs md:text-sm text-[#D1D0D8]">
                  7.4 Финальная оценка и собеседование
                </span>
              </li>
            </ul>
          </div>
